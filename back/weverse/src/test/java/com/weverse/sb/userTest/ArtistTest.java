...
class ArtistTest {
	...
	void insertNJZ() {
		Group group = Group.builder()
				...
				.groupLogo("/images/NewJeans/NewJeans_profile/NewJeans_logo.png")
				.build();
		...
		for (int i = 0; i < memberNames.length; i++) {
			String profileImage = String.format("/images/NewJeans/NewJeans_profile/NewJeans_" + memberEngNames[i] + ".png");
	...
	void insertLESSERAFIM() {
	    ...
	    for (int i = 0; i < memberNames.length; i++) {
	        String profileImage = String.format("/images/LESSERAFIM/LESSERAFIM_profile/" + memberEngNames[i] + ".png");
	        Artist artist = Artist.builder()
	        		.group(group)
	                .stageName(memberNames[i])
	...
	void insertNCTWISH() {
	    ...
	    for (int i = 0; i < memberNames.length; i++) {
	        String profileImage = String.format("/images/NCT_WISH/NCT_WISH_profile/NCT_WISH_" + memberEngNames[i] + ".png");
	        Artist artist = Artist.builder()
	                .group(group)
	                .stageName(memberNames[i])
	...
	void insertRIIZE() {
	    ...
	    for (int i = 0; i < memberNames.length; i++) {
	        String profileImage = String.format("/images/RIIZE/RIIZE_profile/RIIZE_" + memberEngNames[i] + ".png");
	        Artist artist = Artist.builder()
	                .group(group)
	                .stageName(memberNames[i])
	...
	void insertSTAYC() {
	    ...
	    for (int i = 0; i < memberNames.length; i++) {
	        String profileImage = String.format("/images/STAYC/STAYC_profile/STAYC_" + memberEngNames[i] + ".png");
	        Artist artist = Artist.builder()
	                .group(group)
	                .stageName(memberNames[i])
	...
	void insertTWS() {
	    ...
	    for (int i = 0; i < memberNames.length; i++) {
	        String profileImage = String.format("/images/TWS/TWS_profile/TWS_" + memberEngNames[i] + ".png");
	        Artist artist = Artist.builder()
	                .group(group)
	                .stageName(memberNames[i])
	...
	void insertBABYMONSTER() {
	    ...
	    for (String memberName : memberNames) {
	        String profileImage = String.format("/images/BABYMONSTER/BABYMONSTER_profile/BABYMONSTER_" + memberName + ".png");
	        Artist artist = Artist.builder()
	                .group(group)
	...
	void insertBLACKPINK() {
	    ...
	    for (String memberName : memberNames) {
	        String profileImage = String.format("/images/BLACKPINK/BLACKPINK_profile/BLACKPINK_" + memberName + ".png");
	        Artist artist = Artist.builder()
	                .group(group)
	                .stageName(memberName)
	...
	void insert10CM() {
	    ...
	    String profileImage = "/images/10CM/10CM_profile/10CM.png";
