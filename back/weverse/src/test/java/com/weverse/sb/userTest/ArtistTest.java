...
class ArtistTest {
   ...
   ArtistController artistController;
	...
	.groupProfileImage("/images/NewJeans_artistpedia_11.png")
	  ...
	  for (int i = 0; i < memberNames.length; i++) { String profileImage =
	  String.format("/images/NewJeans_artistpedia_%02d.png", i + 2); Artist artist
	  = Artist.builder() .group(group) .stageName(memberNames[i])
   ...
   void insertNCTWISH() {
	   Group group = Group.builder()
			   .groupId(3l)
               .groupName("NCTWISH")
               .groupProfileImage("/images/NCT_WISH_artistpedia01.png")
               .groupLogo("/images/NCT_WISH_artistpedia08.png")
               .build();
       arMapRepository.save(group);
   ...
   void insertRIIZE() {
	   Group group = Group.builder()
               ...
               .groupLogo("/images/RIIZE_artistpedia01.jpg")
               .build();
       arMapRepository.save(group);
   ...
   void insertSTAYC() {
	   Group group = Group.builder()
			   .groupId(5l)
               .groupName("STAYC")
               .groupProfileImage("/images/STAYC_artistpedia_07.jpeg")
               .groupLogo("/images/STAYC_artistpedia_08.jpeg")
               .build();
       arMapRepository.save(group);
   ...
   void insertTWS() {
	   Group group = Group.builder()
			   .groupId(6l)
               .groupName("TWS")
               .groupProfileImage("/images/TWS_artistpedia02.png")
               .groupLogo("/images/TWS_artistpedia01.png")
               .build();
       arMapRepository.save(group);
   ...
   void insert10CM() {
	   Group group = Group.builder()
			   .groupId(9l)
            .groupName("10CM")
            .groupProfileImage("/images/10CM_artistpedia02.png")
